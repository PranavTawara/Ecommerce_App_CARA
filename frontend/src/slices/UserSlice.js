...
const userDataSlice = createSlice({
  ...
  initialState: {
    user: null, // Initial state with user data set to null
  },
  reducers: {
    setUser(state, action) { // Reducer function to set the user data
    ...
    clearUser(state) { // Reducer function to clear the user data
